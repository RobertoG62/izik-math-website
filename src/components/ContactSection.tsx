...
const ContactSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Open WhatsApp
    window.open(`https://wa.me/972543910339?text=${whatsappMessage}`, '_blank');
              ...
              <Card className="p-6 shadow-elegant border-0 bg-white/90 backdrop-blur-sm">
                ...
                <div className="space-y-4">
                  <Button 
                    ...
                    onClick={() => window.open('https://wa.me/972543910339?text=שלום איציק, מעוניין/ת לקבל פרטים על שיעורים פרטיים', '_blank')}
                  >
              ...
              <Card className="p-6 shadow-elegant border-0 bg-white/90 backdrop-blur-sm">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold">60 דקות</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground">מקום:</span>
                    <span className="font-semibold">בבית המורה, אונליין</span>
                  </div>
                </div>
              </Card>
